...
*/
@ActorServiceAttribute(name = "SmokeTestJavaService")
@StatePersistenceAttribute(statePersistence = StatePersistence.Persisted)
public class SmokeTestJavaImpl extends FabricActor implements SmokeTestJava {
    private Logger logger = Logger.getLogger(this.getClass().getName());

    public SmokeTestJavaImpl(FabricActorService actorService, ActorId actorId){
