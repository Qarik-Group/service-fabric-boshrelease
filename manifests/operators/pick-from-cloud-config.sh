...
# The base manifests/azure-service-fabric.yml assumes that your `bosh cloud-config` contains
...
#
# Usage:
#   bosh deploy manifests/azure-service-fabric.yml -o <(./manifests/operators/pick-from-cloud-config.sh)
